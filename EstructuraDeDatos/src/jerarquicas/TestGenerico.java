...
public class TestGenerico {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("\n");
        System.out.println("Recorrido en InOrden.\n Tiene que dar: [ 7 - 9 - 10 - 3 - 10 - 12 - 15 - 20 - 22 - 30 - 40 - 45 - 55]  " + a.listarInorden().toString());

        System.out.println("\n\n*********************************************");
        System.out.println("*   Test del Metodo Frontera de la reentrega  *");
        System.out.println("********************************************\n");
        System.out.println("Primero veamos el estado en el que se encuentra el arbol: \n"+a.toString()+"\n\n");
        System.out.println("Ahora calculamos su frontera \n");
        System.out.println("Frontera del arbol"+a.frontera());
        System.out.println("\n\n");
        System.out.println("+------------------------------------------------+");
        System.out.println("Creo un nuevo arbol y le asigno valores");
        System.out.println("");
    ArbolGen arbol=new ArbolGen();
    arbol.insertar(15,0);    arbol.insertar(9,15);    arbol.insertar(14,15);
    arbol.insertar(7,9);    arbol.insertar(3,9);    arbol.insertar(10,3);
    arbol.insertar(13,3);    arbol.insertar(6,1);    arbol.insertar(12,14);  
    arbol.insertar(30,14);    arbol.insertar(40,30);   arbol.insertar(55,30);
        System.out.println("El estado actual del nuevo arbol creado: \n\n"+arbol.toString());
        System.out.println("\n");
        System.out.println("Frontera del nuevo arbol debe ser [7,10,13,12,40,55]: "+arbol.frontera());
        System.out.println("\n");
        System.out.println("+------------------------------------------------+");
        System.out.println("\n Probamos casos especiales:");
        arbol.vaciar();
        System.out.println("Vacio el arbol actual y listo la frontera debe dar vacio: "+arbol.frontera());
        System.out.println("\n Asigno un solo valor:");
        arbol.insertar(4,0);
