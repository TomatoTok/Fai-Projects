...
public class TestBinario {
   ...
   public static final String RESET = "\u001B[0m";
	...
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("\n\n********************************************");
        System.out.println("*  Test del metodo Ancestros de la reentrega *");
        System.out.println("********************************************\n");
        System.out.println("Veamos el estado del arbol\n");
        ...
        System.out.println("Ancestros de la raiz: "+a.obtenerAncestro(10));
        System.out.println("Ancestros de su hoja mas izquierda: "+a.obtenerAncestro(7));
        System.out.println("Ancestros de su hoja mas derecha: "+a.obtenerAncestro(20));
        System.out.println("Ancestros de un nodo hijo de la raiz: "+a.obtenerAncestro(15));
        System.out.println("\n Casos Especiales: \n");
        System.out.println("Busco ancestros de un elemento que no existe"+a.obtenerAncestro(100));
        System.out.println("Vacio un arbol y busco ancestros en el mismo");
        a.vaciar();
        System.out.println("Listo ancestos en arbol Vacio:"+a.obtenerAncestro(0));
